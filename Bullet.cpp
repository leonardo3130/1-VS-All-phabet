...
int Bullet::move_bul(Map &mappa) {
  ...
  if (this->dir == 0) {
    if (mappa.isEmpty((this->x) + 1, this->y) &&
      ...
      this->x += 1;
    } else if ((mappa.isMoney((this->x) + 1, this->y) ||
                (mappa.isMonster((this->x) + 1, this->y) && this->from)) &&
               mappa.isEmpty((this->x) + 2, this->y)) {
      this->x += 2;
    } else if ((mappa.isMoney((this->x) + 1, this->y) ||
                (mappa.isMonster((this->x) + 1, this->y) && this->from)) &&
               !mappa.isEmpty((this->x) + 2, this->y)) {
    ...
    if (mappa.isEmpty(this->x, (this->y) + 1) &&
      ...
      this->y += 1;
    } else if ((mappa.isMoney(this->x, (this->y) + 1) ||
                (mappa.isMonster(this->x, (this->y) + 1) && this->from)) &&
               mappa.isEmpty(this->x, (this->y) + 2)) {
      this->y += 2;
    } else if ((mappa.isMoney(this->x, (this->y) + 1) ||
                (mappa.isMonster(this->x, (this->y) + 1) && this->from)) &&
               !mappa.isEmpty(this->x, (this->y) + 2)) {
...
char Bullet::getLook() { return this->look; }
int Bullet::getDir() { return this->dir; }
bool Bullet::getFrom() { return this->from; }
